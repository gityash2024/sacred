...
import ReimagineyourcustomerexperienceWalk from '@/assets/WomanShopper.png'
import ReimagineyourcustomerexperienceCoupleWalk from '@/assets/Coupleshopper.png'
import ReimagineyourcustomerexperienceBoy from '@/assets/boy.png'
...
import ShopingTrolly from "@/assets/shoping-trolly.png"
import plusIcon from "@/assets/plusIcon.png"
import rightArrow from "@/assets/rightArrow.png"
import cone from "@/assets/cone.png"
import upArrrow from "@/assets/uparrow.png"
...
export const MyEarthPoint: React.FC = () => {
  ...
  const recognitionCards = [
    ...
    },
    {
      ...
      logo: canneslions,
      description:
        'Honoured by the International Advertising Association at the Cannes Lions Festival of Creativity 2023.',
  ...
  return (
    <>
      ...
      <section
        ...
        style={{ backgroundImage: `url(${backgroundimageearthpoint})` }}
      >
        <div className="hero-content-wrapper">
          <img src={leftbackgroundimagelogos} alt="Left side logos" className="left-side-image" />

          <div className="right-side-content">
            <h1 className="right-side-heading">
              Introducing the
              <br />
              <span className="highlight-text">World's First</span>
              <br />
              <span className="highlight-text">Loyalty Currency</span>
              <br />
              for the Climate
              <br />
              Conscious.
          ...
          <img src={rightsidelogosimage} alt="Right side logos" className="right-side-image" />
        </div>
      </section>
      ...
      <section className="section-two-container">
        <div className="section-two-content">
          <img src={line} alt="Background line" className="line-image" />

          <img src={tigerlogo} alt="Tiger logo" className="tiger-logo" />
          ...
          <div className="left-content">
            ...
            <p className="creating-text">
              Creating endless
              <br />
              <span className="happy-hours-text">happy hours.</span>
              <br />
              <span className="that-reward-text">
                That reward people,
                <br />
                businesses, and the
                <br />
                planet, with every tap,
                <br />
                swipe, or checkout.
              </span>
            </p>
      ...
      <section className="section-three-container">
        <div className="section-three-content">
          <img src={Partnerbackgroundline} alt="Background line" className="partner-line-image" />
          <img src={cornerLine} alt="Background line" className="partner-line-image-2" />

          <div className="cow-container">
            <img src={cowroundimageGroup} alt="Cow background" className="cow-background" />
            <img src={cow} alt="Cow logo" className="cow-logo" />
          </div>

          <img src={WomanShopper} alt="Woman Shopper" className="woman-shopper-image" />

          <img src={boy} alt="Boy" className="boy-image" />

          <img src={Coupleshopper} alt="Couple Shopper" className="couple-shopper-image" />

          <img src={bander} alt="Bander" className="bander-image" />
          ...
          <div className="environmentally-conscious-text">
            ...
            <a
              href="https://www.bcg.com/publications/2024/trillion-dollar-opportunity-in-womens-products-and-services"
              target="_blank"
              rel="noopener noreferrer"
              className="eco-source"
            >
          ...
          <div className="affluent-text">
            ...
            <a
              href="https://www.pwc.com/gx/en/news-room/press-releases/2024/pwc-2024-voice-of-consumer-survey.html"
              target="_blank"
              rel="noopener noreferrer"
              className="affluent-source"
            >
              PwC ↗
            </a>
          </div>
      ...
      <section className="section-five-container">
        <div className="section-five-content">
          ...
          <div className="journey-right-content">
            <img src={YourClimateActlogo} alt="Your Climate Act" className="climate-act-logo" />
          ...
          {/* Bottom Image */}
          <img src={earth_bottom} alt="Earth bottom decoration" className="earth-bottom-image" />
        </div>
      </section>
          ...
          <div className="section-seven-about-right">
            ...
            <div className="section-seven-about-right-content">
              ...
              <div className="section-seven-about-right-text">
                <p>
                  Sacred Groves is a <strong>Community Interest Company</strong> incorporated in the
                  United Kingdom, reimagining business in partnership with nature — our ultimate
                  shareholder.
                </p>
                <p>
                  With Guardians in over <strong>30 countries</strong>, we protect three biodiverse
                  habitats in the UK and Canada.
                </p>
                <p>
                  By 2030, our goal is to safeguard a million acres of critical ecosystems across
                  the planet.
                </p>
              </div>
            </div>
          ...
          <div className="section-eight-green-section">
            ...
            <div className="section-eight-icon-row">
              <img
                ...
                className="section-eight-technology-icons"
              />
            </div>
            ...
            <div className="section-eight-text-block">
              <p className="section-eight-paragraph">
                Sacred Groves is a <strong>Community Interest Company</strong> <br /> incorporated
                in the United Kingdom, reimagining <br /> business in partnership with nature — our
                ultimate <br /> shareholder.
              </p>

              <p className="section-eight-paragraph">
                With Guardians in over <strong>30 countries</strong>, we protect <br /> three
                biodiverse habitats in the UK and Canada.
                <br />
                By 2030, our goal is to safeguard a million acres of <br /> critical ecosystems
                across the planet.
              </p>
            </div>
          </div>
          ...
          <div className="section-eight-dark-section">
            ...
            <div className="section-eight-desktop-content">
              ...
              <div className="section-eight-forest-logo-wrapper">
                <img
                  src={coedwing}
                  alt="Coedwig Genedlaethol Cymru - National Forest for Wales"
                  className="section-eight-forest-logo"
                />
                <div className="section-eight-forest-logo-text">
                  <p className="section-eight-forest-logo-title">
                    Coedwig
                    <br />
                    Genedlaethol Cymru
                  </p>
                  <p className="section-eight-forest-logo-subtitle">
                    National Forest
                    <br />
                    for Wales
                  </p>
              ...
              <div className="section-eight-forest-description">
                <p className="section-eight-forest-text">
                  Once marked for private sale,
                  <br />
                  these forests are now a part of
                  <br />
                  the 'National Forest for Wales'
                  <br />
                  network, helping build a<br />
                  contiguous green corridor
                  <br />
          ...
          <div className={styles.recognizedContent}>
              ...
              {getVisibleCards().map(card => (
                ...
                >
                  <div className={styles.recognizedCardHeader}>
                    <div
                      className={`${styles.recognizedLogoContainer} ${card.logoAlignment === 'left' ? styles.recognizedLogoContainerLeft : card.logoAlignment === 'right' ? styles.recognizedLogoContainerRight : ''}`}
                    >
                      <img
                        src={card.logo}
                        alt="Recognition Logo"
                        className={styles.recognizedMainLogo}
                      />
                    </div>
                  </div>
                  <p className={styles.recognizedCardDescription}>{card.description}</p>
                </a>
              ))}
            </div>
            ...
            <div className={styles.recognizedCarouselNavigation}>
              ...
              <button
                ...
                style={{
                  visibility: isMobile
                    ? currentCardIndex === recognitionCards.length - 1
                      ? 'hidden'
                      : 'visible'
                    : currentCardPage === 1
                      ? 'hidden'
        ...
        <div className={styles.sec7Content}>
          <div className={styles.sec7Left}>
            ...
            <p className={styles.sec7Para}>
              With Guardians in over <strong>30 countries</strong>, we protect
              <br />
              three biodiverse habitats in the UK and Canada.
              <br />
              By 2030, our goal is to safeguard a million acres of
              <br />
  ...
  const personas = [
    {
      ...
      description:
        'A conscious yet indecisive shopper. Loves exploring high fashion brands, seeks value and meaning, often returns purchases, and responds strongly to offers and rewards.',
      shopImage: bag,
      shopItem: 'Shop',
      earnPoints: '30',
      ...
      walkImage: ReimagineyourcustomerexperienceWalk,
    },
    {
      id: 1,
      name: 'Max',
      ...
      profession: 'Artist',
      description:
        'A value conscious young artist who is price-sensitive, and wants good-quality wearables without overspending. His goal is simple; make choices that align with his values. Max feels good when his everyday shopping also supports something bigger like; protecting the planet.',
      shopImage: jacket,
      shopItem: 'Shop',
      earnPoints: '10',
      earnLabel: 'myEarth Points',
      ...
      walkImage: ReimagineyourcustomerexperienceBoy,
    },
    {
      id: 2,
      name: 'Jia & Will',
      ...
      profession: 'Bankers',
      description:
        'A globe trotting and impact-aware couple. Their travel begins with mindful selections. They choose low-impact conveniences like opting out of housekeeping, using shared transfers, and dining within the resort. They enjoy their journeys most when their decisions visibly reduce their footprint and contribute to conservation efforts.',
      shopImage: Plane,
      shopItem: 'Shop',
      earnPoints: '100',
      earnLabel: 'myEarth Points',
      ...
      bonusPoints: '50',
      bonusLabel:
        'myEarth Points for the green hospitality like dining in-house, skipping house keeping etc',
      bonusIcon: '+',
      ...
      walkImage: ReimagineyourcustomerexperienceCoupleWalk,
    },
  ]
  ...
  return (
    <section className="section-four-container">
      <div className="section-four-content">
        <img src={Reimagineline} alt="Background line" className="reimagine-line-image" />
        <img src={Reimaginetopline} alt="Background line" className="reimagine-line-image-2" />
        ...
        <div className="persona-icons-container">
          {personas.map((persona, index) => (
            ...
            >
              <img src={persona.personImage} alt={persona.name} className="persona-icon-image" />
            </div>
          ))}
        </div>
        ...
        <div className="persona-gif">
          <div className="section-four-gif-top-container">
            <div>
              <div className="section-four-gif-top-container-shop">
                <h2 className="section-four-gif-top-container-shop-title">
                  {currentPersona.shopItem}
                </h2>
                <img src={currentPersona.shopImage} className='section-four-shopImage' alt="" />
              </div>
              {/* Arrow Down */}
              {/* <div className="downarrow"></div>
              <div className="downarrowrightside"></div>
              <div className="downarrowleftside"></div> */}
              <img src={downArrow} className="downarrow" alt="" />
              <div className="section-four-gif-top-container-shop">
                <h2 className="section-four-gif-top-container-shop-title">Earn</h2>
                <div className="section-four-gif-top-container-earn">
                  <div className="section-four-gif-top-container-bonus">
                    <h2 className='section-four-bonuspoint'>{currentPersona.bonusPoints}</h2>
                    <p className='section-four-earnbLabel'>{currentPersona.earnLabel}</p>
                  </div>
                  <div className='section-four-earnIcon-wrapper'>
                    <img src={ShopingTrolly} className='section-four-earnIcon' alt={currentPersona.earnLabel} />
                  </div>
                </div>
                <div className="section-four-gif-top-container-earn">
                  <div className="section-four-gif-top-container-bonus">
                    <h2 className='section-four-bonuspoint'>{currentPersona.bonusPoints}</h2>
                    <p className='section-four-earnbLabel'>{currentPersona.bonusLabel}</p>
                  </div>
                  <div className='section-four-earnIcon-wrapper'>
                    <img src={plusIcon} className='section-four-earnIcon' alt={currentPersona.bonusLabel} />
                  </div>
                </div>
              </div>
...
const NudgeSection: React.FC = () => {
  ...
  return (
    <section className="section-six-container" style={{ backgroundImage: `url(${nude_bg})` }}>
      <div className="section-six-content">
        {/* Main Heading */}
        <h2 className="section-six-heading">
          Nudge better choices
          <br />
              ...
              {hoveredItem === item.id ? (
                <div className="nudge-hover-banner">
                  ...
                  <div className="hover-banner-right">
                    <img src={item.image} alt={item.title} className="hover-banner-image" />
                  </div>
                </div>
              ) : (
        ...
        <div className="section-six-bottom-content">
          <h2 className="build-model-heading">Build your myEarth Point Model</h2>
