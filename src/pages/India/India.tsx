...
// Import assets
import indiaBg from '@/assets/india_bg.svg'
...
// Section 3 assets - Carousel images for Partnership for the Planet
...
export const India: React.FC = () => {
    ...
    const tabs = [
        { line1: 'Partnership', line2: 'for the Planet' },
        { line1: 'myEarth', line2: 'Point' },
        { line1: 'Junk to', line2: 'Jungles' },
        { line1: 'Seeds of', line2: 'Recognition' },
        { line1: 'Brand a', line2: 'Habitat' }
    ]
    ...
    // Auto-rotate carousel for first tab
    useEffect(() => {
        if (activeTab === 0) {
    ...
    return (
        <>
            <SEO
                title={PAGE_SEO.india.title}
                description={PAGE_SEO.india.description}
                keywords={PAGE_SEO.india.keywords}
                ogImage={PAGE_SEO.india.ogImage}
                breadcrumbs={BREADCRUMBS.india}
            />

            {/* Hero Section */}
            <section className={styles.heroSection} style={{ backgroundImage: `url(${indiaBg})` }}>
                        ...
                        <div className={styles.section3Content}>
                            <div className={styles.myEarthLeft}>
                                <div className={styles.myEarthBgContainer}>
                                    ...
                                    <img src={myEarthPointImage} className={styles.myEarthImage} alt="Receipt" />
                                </div>
                            </div>
                    ...
                    {activeTab === 2 && (
                        <div className={styles.section3Content}>
                            <div className={styles.myEarthLeft}>
                                <div className={styles.myEarthBgContainer}>
                                    <img src={myEarthPointBg} className={styles.myEarthBg} alt="Background" />
                                    <img src={junkToJungleImage} className={styles.myEarthImage} alt="Junk to Jungles" />
                                </div>
                            </div>
                    ...
                    {activeTab === 4 && (
                        <div className={styles.section3Content}>
                            <div className={styles.myEarthLeft}>
                                <div className={styles.myEarthBgContainer}>
                                    <img src={myEarthPointBg} className={styles.myEarthBg} alt="Background" />
                                    <img src={brandAHabitatImage} className={styles.myEarthImage} alt="Brand a Habitat" />
                                </div>
                            </div>
